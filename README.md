...
- GUI 端：
  ...
  - 配置“启动后自动开始监控”
  - 配置“关闭窗口时最小化到托盘”
  - 配置 HDR 切换提示：开关、位置、亮屏延迟、文案预设、自定义文案、显示时长
...
- HDR 提示：WPF 无焦点置顶 Toast 窗口，在 HDR 黑屏重协商后延迟显示，短暂淡入淡出，不复用 InputTip 代码
...
8. 需要切换时提示状态，勾选“启用 HDR 切换提示”，并设置提示位置、亮屏延迟和文案。
9. 点击“开始监控”。
...
“切换后等待亮屏延迟”用于避开 Windows 切换 HDR 时的黑屏/重协商时间，默认 `1800ms`。如果你的显示器黑屏更久，可以调高到 2500–3500ms。
